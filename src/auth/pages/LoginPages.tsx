              ...
              <div className="flex flex-col gap-6 min-h-[400px]  justify-between">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Somos una concesionaria con las mejores marcas de
                    motocicletas y repuestos, piezas, accesorios. ofreciendo con
                    soporte y servicios técnico especializado
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-5">
                    <Button
                      ...
                      onClick={() =>
                        redirectToExternal(
                          "https://www.facebook.com/share/1AE1zW2o3q/"
                        )
                      }
                    >
